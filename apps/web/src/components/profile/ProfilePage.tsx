...
import { PortfolioGrid } from "@/app/profile/_components/PortfolioGrid";
import { BadgesGrid }    from "@/app/profile/_components/BadgesGrid";
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input type="password" value={newStPassword} onChange={(e) => setNewStPassword(e.target.value)}
                placeholder="12+ caracteres, mayúscula, minúscula, número y especial" className="w-full border border-slate-200 rounded-xl px-3.5 py-2.5 text-sm focus:ring-2 focus:ring-amber-200 outline-none" />
