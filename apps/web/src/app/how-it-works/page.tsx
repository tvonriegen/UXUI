    ...
    <PublicShell>
      <section className="mx-auto max-w-5xl px-4 py-12 sm:px-6 sm:py-16 lg:px-8">
        <div className="max-w-2xl animate-fade-in-up">
          <p className="text-sm font-bold uppercase tracking-[0.2em] text-sky-600">El recorrido TalentHub</p>
        ...
        <div className="mt-12 grid gap-5 md:grid-cols-3">
          <article className="rounded-2xl border border-slate-200/60 bg-white p-6 shadow-sm animate-fade-in-up stagger-1">
            <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-sky-50 text-sky-600"><Sparkles size={21} /></div>
            <p className="mt-6 text-xs font-bold uppercase tracking-[0.18em] text-sky-600">01</p>
          ...
          <article className="rounded-2xl border border-slate-200/60 bg-white p-6 shadow-sm animate-fade-in-up stagger-2">
            ...
            <p className="mt-6 text-xs font-bold uppercase tracking-[0.18em] text-emerald-600">02</p>
        ...
        <div className="mt-10 flex flex-wrap gap-3">
          <Link href="/explore" className="inline-flex items-center gap-2 rounded-xl bg-sky-500 px-5 py-3 text-sm font-bold text-white transition-colors hover:bg-sky-600">Explorar talento <ArrowRight size={16} /></Link>
